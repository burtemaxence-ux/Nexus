...
|---|---|---|
| Reconstruire 57 000 lignes, 63 pages, 99 routes, 262 tests | ~5-6 mois de développeur senior | **6 à 10 semaines** avec un agent de codage |
...
« 57 000 lignes, 262 tests, environ six mois de travail ». **En 2026, cet argument travaille
...
| « 262 tests » (seul) | « 262 tests **qui verrouillent les circuits d'argent et les 17 règles de droit** » |
