...
1. **Cloner, installer, faire tourner les tests.** `npm install && npm test` → doit afficher
   278 tests verts sur 31 fichiers. Si ce n'est pas le cas, s'arrêter là et le signaler :
...
- **Aucun test de bout en bout.** 278 tests unitaires et d'intégration, mais pas de parcours
