...
const FAQS = [
  ...
  { q: "Que se passe-t-il après les 30 jours d'essai ?", a: "Rien d'automatique. Aucune carte bancaire n'est demandée à l'inscription : vous choisissez librement de continuer, ou pas. Zéro mauvaise surprise." },
