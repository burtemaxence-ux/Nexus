...
const FEATURES = [
  ...
  { icon: BarChart3, label: 'Analytiques',            desc: 'Suivez les heures, coûts et performances de votre établissement.' },
]

export default function DemoPage() {
  const error = false // server component, no searchParams needed for basic display
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto text-center space-y-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-[16px] leading-relaxed text-[#6B7280] dark:text-[#8B90A7] max-w-[480px] mx-auto">
            Accédez instantanément à un compte démo pré-rempli avec un restaurant fictif complet — planning, employés, congés et analytiques.
          </p>
        </div>
        ...
        {error && (
          <p className="text-[13px] text-red-500 bg-red-50 border border-red-100 rounded-xl px-4 py-3">
            La démo est momentanément indisponible. Réessayez dans quelques instants.
          </p>
        )}
