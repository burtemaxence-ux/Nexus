...
const STEPS = [
  { icon: <UserPlus size={22} color="#6C63FF" strokeWidth={1.9} />, accent: '#6C63FF', n: '1', title: 'Ajoutez votre équipe', body: "Créez vos salariés (nom, e-mail, poste, contrat, heures hebdo). Chacun reçoit une invitation pour accéder à son planning sur son téléphone. Aucun import de fichier requis." },
  ...
  return (
    <PageWrap>
      ...
      <Section title="Pour bien démarrer">
        <CheckList
          items={[
            ...
            <>Créez une <strong style={{ color: '#fff' }}>semaine type</strong> puis dupliquez-la : vous gagnez encore du temps chaque semaine.</>,
      ...
      <Section title="Ce que vous débloquez tout de suite">
        <CardGrid cols={3}>
          <InfoCard icon={<Clock size={22} color="#6C63FF" strokeWidth={1.9} />} accent="#6C63FF" title="Badgeuse & présences">Vos équipes pointent depuis leur téléphone ; les heures réelles se comparent au planning.</InfoCard>
          <InfoCard icon={<ListChecks size={22} color="#00D4AA" strokeWidth={1.9} />} accent="#00D4AA" title="Congés & conformité">Validez les congés et bloquez automatiquement la planification sur ces jours.</InfoCard>
