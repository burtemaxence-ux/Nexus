  ...
  return (
    <article className="prose-legal">
      ...
      <section>
        ...
        <p>
          <strong>Conformité des plannings.</strong> Quartzbase est un outil d&apos;aide à la décision pour la planification du personnel. Les vérifications de conformité fournies par l&apos;application (repos quotidien, durées maximales, pauses, etc.) constituent une assistance automatisée basée sur les règles du Code du Travail en vigueur à la date de génération du planning, et ne remplacent en aucun cas un conseil juridique professionnel. L&apos;utilisateur (le gérant ou responsable de l&apos;établissement) reste seul et entièrement responsable de la conformité légale de ses plannings et de ses décisions en matière de droit du travail, ainsi que du respect de sa convention collective applicable. Quartzbase ne pourra être tenu responsable d&apos;un litige, d&apos;un contrôle ou d&apos;une sanction résultant de l&apos;utilisation de l&apos;application, ni des conséquences d&apos;un planning publié malgré une alerte de non-conformité.
        </p>
      </section>
