...
const PROBES: Probe[] = [
  ...
  // Pas de sonde `attach_invited_user` : le rattachement de l'invité à son
  // tenant reste porté par la route /api/employees/invite (client service_role),
  // et non par une fonction SQL dédiée. Voir 091 pour le durcissement de
  // handle_new_user, qui est le chemin réellement exposé au navigateur.
  {
    id: 'B2',
